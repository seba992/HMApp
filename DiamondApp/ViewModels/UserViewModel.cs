           ...
           // FillNeededList();
            try
            {
               ...
               //detale rezerwacji
                ...
                //wyposazeni sali
                PropHallEqThing0=editDetalis.Hall;

                var editEquipment = (from q in _ctx.PropHallEquipment
                    where q.Id_proposition == _idProposition
                    select q).ToList();
                MessageBox.Show(editEquipment[0].Things);
                //PropHallEqThing0 = editEquipment[0].Things;
                ...
                try
                {
                    ...
                    PropHallEqVat2 = editEquipment[1].Vat;
                }
                catch (Exception)
                {
                ...
                _propHallEquipment = editEquipment;
               
                var editEquipmentDiscount = (from q in _ctx.PropHallEquipmentDiscount
                                             where q.Id_proposition == _idProposition
                                             select q).SingleOrDefault();
               ...
               //Marża
               var editMerge = (from q in _ctx.PropMenuMerge
                                where q.Id_proposition == _idProposition
                                select q).ToList();
                 MessageBox.Show(editMerge[1].DefaultValue.ToString());
               _propMenuMerges = editMerge;
          /*      try
                {
                    PropMenuMerge0 = _propMenuMerges[0].DefaultValue;
                    PropMenuMerge1 = _propMenuMerges[1].DefaultValue;
                    PropMenuMerge2 = _propMenuMerges[2].DefaultValue;
                    PropMenuMerge3 = _propMenuMerges[3].DefaultValue;
                    PropMenuMerge4 = _propMenuMerges[4].DefaultValue;
                }
                catch (Exception e)
                {
