...
insert PropMenuGastronomicThings_Dictionary_First (ThingName,NettoMini,Vat,MergeType,SpecificType) values ('Lunch serwowany - 1 danie g³ówne', 25.42 ,0.08,'MGA8','Lunch');
insert PropMenuGastronomicThings_Dictionary_First (ThingName,NettoMini,Vat,MergeType,SpecificType) values ('Zestaw œl¹ski ( zupa + danie g³ówne + deser,SpecificType)', 45.39 ,0.08,'MGA8','Lunch');
...
insert PropMenuGastronomicThings_Dictionary_First (ThingName,NettoMini,Vat,MergeType,SpecificType) values ('Lunch bufetowy (2-zupy , 2-dodatki miêsne 1 dodatek rybny, 2-dodatki syc¹ce, 3-surówki, 2 desery)',  64.19 ,0.08,'MGA8','Lunch');
...
insert PropMenuGastronomicThings_Dictionary_First (ThingName,NettoMini,Vat,MergeType,SpecificType) values ('Grill z Grillo-wêdzarni¹', 41.94 ,0.08,'MGA8','Kolacja');
...
insert PropMenuGastronomicThings_Dictionary_First (ThingName,NettoMini,Vat,MergeType,SpecificType) values ('Zupa gulaszowa  pikantna  wêgierska' , 14.70 ,0.08,'MGA8','Dania');
...
insert PropMenuGastronomicThings_Dictionary_First (ThingName,NettoMini,Vat,MergeType,SpecificType) values ('Finlandia 0,5 l', 45.51,0.23,'MALK','Wódki');
insert PropMenuGastronomicThings_Dictionary_First (ThingName,NettoMini,Vat,MergeType,SpecificType) values ('Absolut 0,04 l', 4.67,0.23,'MALK','Wódki');
insert PropMenuGastronomicThings_Dictionary_First (ThingName,NettoMini,Vat,MergeType,SpecificType) values ('Absolut 0,5 l', 45.51,0.23,'MALK','Wódki');
insert PropMenuGastronomicThings_Dictionary_First (ThingName,NettoMini,Vat,MergeType,SpecificType) values ('¯ubrówka 0,04 l', 3.50,0.23,'MALK','Wódki');
insert PropMenuGastronomicThings_Dictionary_First (ThingName,NettoMini,Vat,MergeType,SpecificType) values ('¯ubrówka 0,5 l', 35.01,0.23,'MALK','Wódki');
insert PropMenuGastronomicThings_Dictionary_First (ThingName,NettoMini,Vat,MergeType,SpecificType) values ('Wiœniówka 0,04 l', 3.50,0.23,'MALK','Wódki');
insert PropMenuGastronomicThings_Dictionary_First (ThingName,NettoMini,Vat,MergeType,SpecificType) values ('Wiœniówka 0,5 l', 35.01,0.23,'MALK','Wódki');
insert PropMenuGastronomicThings_Dictionary_First (ThingName,NettoMini,Vat,MergeType,SpecificType) values ('Gorzka ¿o³¹dkowa 0,04 l', 3.50,0.23,'MALK','Wódki');
insert PropMenuGastronomicThings_Dictionary_First (ThingName,NettoMini,Vat,MergeType,SpecificType) values ('Gorzka ¿o³¹dkowa0,5 l', 35.01,0.23,'MALK','Wódki');
