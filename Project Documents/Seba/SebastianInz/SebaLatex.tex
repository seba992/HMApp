...
\begin{itemize}
\item \textsl{Nazwa klienta} 

Przez wzglπd na moøliwoúÊ obs≥ugi klientÛw biznesowych wprowadzone zosta≥o pole umoøliwiajπce wpisanie nazwy firmy, ktÛrπ klient reprezentuje. W celu jednoznacznej identyfikacji kaødej propozycji cenowej, uznano iø pole to bÍdzie jednπ z kolumn listy propozycji okna g≥Ûwnego.

\item \textsl{Adres klienta} 

Pole to przeznaczone jest do wpisania adresu klienta zarÛwno w przypadku osoby indywidualnej jak i firmy. Po analizie wszelkich za≥oøeÒ projektowych nie wystπpi≥a koniecznoúÊ rozdzielenia danych adresowych - potrzebne sπ one tylko i wy≥πcznie do opisu klienta na wygenerowanym dokumencie PDF.
\item Trzeci punkt
\item \ldots
\end{itemize}
