...
Modu≥ logowania jest czÍúciπ systemu, do ktÛrej dostÍp posiada kaødy uøytkownik korzystajπcy z prezentowanej aplikacji. Implikuje to koniecznoúÊ jego zabezpieczenia przed niepowo≥anym uøyciem i dostÍpem do poufnych danych. Dobrπ praktykπ odnoszπc siÍ do bezpieczeÒstwa jest nieprzechowywanie w øadnym miejscu has≥a w postaci jawnej. 

Pole wpisywania has≥a przez uøytkownika w oknie logowania stanowi dedykowana dla tego celu kontrolka - PasswordBox. Jest to zmodyfikowana kontrolka TextBox dostÍpna w technologi WPF, ktÛra wyúwietla swojπ zawartoúÊ w postaci ukrytej, uniemoøliwiajπc jednoczeúnie wykonanie na niej operacji kopiowania oraz wycinania. Zabezpiecza to przed niechcianym podejrzeniem has≥a przez osobÍ trzeciπ oraz niweluje problem jego odzyskania.

Sama operacja sprawdzania poprawnoúci wpisanego has≥a zosta≥a zaprojektowana w taki sposÛb, aby otrzymane z kontrolki has≥o nie by≥o nigdzie zapisywane i porÛwnywane w postaci jawnej. W chwili otrzym

ZRZUT KONTROLKI



 znajdujπcych siÍ dla przyk≥adu w bazie danych, z ktÛrπ nawiπzywane jest po≥πczenie. 
