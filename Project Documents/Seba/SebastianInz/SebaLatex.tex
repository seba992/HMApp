...
Kolejnym miejscem zastosowania biblioteki Extended WPF Toolkit jest ustalanie z poziomu programu daty. Kontrolka DateTimePicker umoøliwia uøytkownikowi wyboru daty w ustandaryzowanym formacie. Po operacji naciúniÍcia kursorem myszki w przedstawianπ kontrolkÍ wyúwietlany jest przejrzysty kalendarz, w ktÛrym proces wyboru daty polega na wybraniu przez uøytkownika odpowiedniego roku, miesiπca, a nastÍpnie klikniÍcia w dzieÒ odpowiadajπcy jego potrzebom.
