...
Kontrolka DatePicker umoøliwia uøytkownikowi wybÛr daty w ustandaryzowanym formacie. Po operacji naciúniÍcia kursorem myszki w przedstawianπ kontrolkÍ wyúwietlany jest przejrzysty kalendarz, w ktÛrym proces wyboru daty polega na wybraniu przez uøytkownika odpowiedniego roku, miesiπca, a nastÍpnie klikniÍcia w dzieÒ odpowiadajπcy jego potrzebom. Istnieje takøe moøliwoúÊ wpisania rÍcznie daty, z tπ rÛønicπ, iø musi byÊ ona podana w formacie RRRR-MM-DD. Zapis daty w innych formatach zostanie automatycznie wykryty przez mechanizmy wewnÍtrzne kontrolki jako niepoprawny, a wpisana wartoúÊ usuniÍta.
...
\tab NIP jest kolejnym polem opcjonalnym, ktÛre w przypadku klientÛw biznesowych przeznaczone jest do wpisania numeru identyfikacji podatkowej.

TODO: uzyskaÊ informacjÍ czy osoby indywidualne zobligowane sπ do wpisania NIP/PESEL
...
Ostatniπ zak≥adkπ procesu tworzenia nowej propozycji cenowej jest zak≥adka umoøliwiajπca dodanie indywidualnie ustalanych elementÛw, ktÛre nie sπ dostÍpne w zakresie standardowych us≥ug oferowanych przez sieÊ hotelowπ oraz finalnej formy w ktÛrej realizowana bÍdzie zap≥ata. <TODO: dodaÊ o sumie koncowej>

W celu realizacji procesu dodania us≥ugi niestandardowej, pracownik ma obowiπzek uzyskania od prze≥oøonego informacji dotyczπcej fizycznej moøliwoúci jej realizacji podczas organizowanego wydarzenia i w sytuacji akceptacji moøe zapisaÊ jej nazwÍ w polu \textsl{Rodzaj us≥ugi}, uzupe≥niÊ ustalonπ cenÍ brutto wraz z wartoúciπ VAT oraz wybraÊ iloúÊ oraz liczbÍ dni. Tak utworzony rekord us≥ugi zostanie, analogicznie jak w przypadku poprzednich zak≥adek odpowiednio przeliczony i wyúwietlony w polach dotyczπcych wartoúci.
