...
Kolejne wersje niniejszego projektu sπ wydawane zgodnie z zasadami Continuous Delivery. Plan \textit{Build Project} pobiera kod ürÛd≥owy z repozytorium zapisanym na GitHubie. CA£A SEKCJA DO DOKONCZENIA.
...
Aby umoøliwiúc edycjÍ danych z poziomu DataGridView, zaimplementowano funckjÍ obs≥ugujπcπ zdarzenie DataGridRowEditEndingEventArgs. Kiedy edycja danje komÛrki zostaje zakoÒczona, wywo≥ywane jest wnÍtrze funkcji ktÛrej zadaniem jest dynamiczne przechwycenie nowej wartoúci i aktualizacja bazy danych. Uøycie zmiennej dynamic, podyktowane jest tym øe jest ona sprawdzana podczas wywo≥ania, a nie kompilacji \cite{dynamic} co umoøliwia odwo≥anie do nowych wartoúci zapisanych w komÛrkach. Kod funkcji jest jest nastÍpujπcy: 
...
Za pomocπ mechanizmÛw biblioteki MigraDoc, zaimplementowano funckje tworzπce tabele propozycji cenowej:
\begin{verbatim}
...
Poniøszy kod, umoøliwia zapis dokumentu w formacie PDF.
