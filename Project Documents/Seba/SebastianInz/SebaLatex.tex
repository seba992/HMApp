...
\subsection{tworzenie propozycji}

- dynamicznie rozwijane listy podczas tworzenia propozycji cenowej (iloúÊ rzeczy do wyboru w kaødym tabie)

\subsection{historia zmian propozycji cenowej}

- widoczne logi zmian, widaÊ co sprzedawca edytowa≥ i kiedy

\subsection{modu≥ statystyk}

- kto ile zorganizowa≥ wydarzeÒ, na jakie kwoty, ogÛlna aktywnoúÊ sprzedawcÛw widoczna z konta administratora
