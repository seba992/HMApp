...
\tab W zaleønoúci od wybranej z listy rozwijanej sali oraz uprzednio wybranej dacie rozpoczÍcia wydarzenia, sprzedawca ma moøliwoúÊ otrzymania informacji o cenie sali, jej powierzchni oraz liczbie dostÍpnych miejsc. Informacje te w czasie ustalania szczegÛ≥Ûw transakcji umoøliwiajπ wybÛr optymalnego dla potrzeb klienta pomieszczenia, w ktÛrym przez wzglπd na liczbÍ dostÍpnych miejsc bÍdzie moøna rozlokowaÊ wszystkich uczestnikÛw. Wybrana z listy rozwijanej sala wraz z datπ rozpoczÍcia jednoznacznie identyfikuje pomieszczenie oraz jej cenÍ, ktÛrej rekord w sposÛb automatyczny dodawany jest jako pierwszy w kolejnej zak≥adce opisujπcej szczegÛ≥y rezerwacji.

\item \ldots
\end{itemize}

TODO: po edycji graficznej wrzuciÊ tab1 testuje jaki jest margines testuje jaki jest margines testuje jaki jest margines testuje jaki jest margines 
