...
Wpisanie b≥Ídnego has≥a lub nazwy konta wychwytywane jest przez mechanizmy modu≥u logowania, ktÛry zwraca informacjÍ o problemie wraz z jego opisem. W celu zwiÍkszenia bezpieczeÒstwa wypisywana jest ogÛlna informacja o otrzymaniu b≥Ídnych danych, a nie wyszczegÛlniona, ktÛra informacja zosta≥a podana b≥Ídnie.
