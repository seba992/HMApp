...
//wymagane manualne dodanie pliku konfiguracyjnego po≥πczenia
SqlConnection connection = new SqlConnection(connectionString);

SqlCommand command = 
    new SqlCommand(@"INSERT INTO [TestDb].[Users]  
    VALUES (@Login, @Password)", connection);           
command.Parameters.Add(new SqlParameter("Login", "TestLogin"));
command.Parameters.Add(new SqlParameter("Password","TestPa$$"));            
connection.Open();
...
// EF automatycznie odczyta plik konfiguracyjny po≥πczenia
...
TODO: /odnoúnik do zrzutu ekranu ilustrujπcπ tÍ sytacjÍ/ (wrzuciÊ po poprawkach wizualnych programu)
...
TODO: ZRZUT REKORDU W BAZIE DANYCH (HASHE HASEL) + KOD POR”WNUJ•CY HAS£A GDY W£•CZ  HASZE

\subsubsection{Szyfrowanie hase≥ - funkcja skrÛtu SHA2}
Pytanie: czy dzia≥ jest warty opisania. czy SHA2 skrÛtowo opisaÊ w bezpieczeÒstwie procesu logowania
