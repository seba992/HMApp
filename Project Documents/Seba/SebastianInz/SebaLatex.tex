...
Model jest to warstwa, ktÛra odpowiedzialna jest w omawianym wzorcu za logikÍ biznesowπ aplikacji \cite{LogikaBiznesowa}. W przypadku przedstawianego projektu inøynierskiego warstwa ta reprezentowana jest przez przez klasy, ktÛre utworzone zosta≥y za pomocπ oprogramowania Entity Framework, s≥uøπcego do odwzorowania relacyjnej bazy danych na obiekty dostÍpne z poziomu kodu. Przekazywanie informacji do kontrolek wykorzystanych w aplikacji WPF odbywa siÍ za poúrednictwem systemu bindowania. Wszelkie klasy zawierajπce dane, ktÛre maja przekazane byÊ z poziomu modelu do warstwy widoku, z ktÛrego uøytkownik moøe owe informacje odczytaÊ zobowiπzane sπ do implementacji interfejsu INotifyPropertyChanged lub INotifyPropertyChanged, ktÛry umoøliwia przeprowadzenie powyøszej operacji.
