...
\tab 	G³ównym i najwa¿niejszym elementem tego œrodowiska jest kompilator, który wytwarza program z linii kodu, a dok³adniej t³umaczy kod  zapisany w jêzyku programowania na kod zrozumia³y dla sprzêtu to znaczy maszynowy. W wypadku produktu linii Visual studio mo¿e on pracowaæ w dwóch trybach release i debug, ka¿dy z nich charakteryzuje siê innymi parametrami. W trybie debug gdy  program jest kompilowany  jest mo¿liwe debugowanie z wykorzystaniem wbudowanego debugera, ale o tym w dalszej czêœci tego rozdzia³u. Niestety w tym trybie jest brak optymalizacji kodu, jest tworzona ca³a otoczka umo¿liwiaj¹ca debugowanie. W drugim trybie s¹ uruchamiane optymalizacje miedzy, innymi tak zwane inline, która polega w du¿ym uproszczeniu na przekopiowane na przyk³ad cia³a funkcji w miejsce w którym zosta³a ona wywo³ana. Dodatkowe mechanizmy optymalizacji powoduj¹ niemo¿liwoœæ znajdowania b³êdów.   
