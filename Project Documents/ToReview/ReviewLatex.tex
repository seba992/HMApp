...
\tab W programie ProfitCRM  istnieje rÛwnieø moøliwoúÊ zdefiniowania w≥asnego szablonu. Proces tworzenia nowego szablonu jest procesem skomplikowanym. Najlepszym rozwiπzanie jest skopiowanie istniejπcych w systemie szablonÛw, poniewaø ich edycja jest zablokowana.  NastÍpnie edytowanie skopiowanego. Nie powiod≥o siÍ rÛwnieø wygenerowanie PDF o wyglπdzie zbliøonym do wyglπdu przedstawionego przez sieÊ hotelowπ. Niestety w programie Asystent CRM edycja wzorÛw dokumentÛw do druku jest bardzo trudna w realizacji dla zwyk≥ego sprzedawcy. Jest to spowodowane sposobem edycji. Bez znajomoúci programowania nie ma moøliwoúci stworzenia nowej wersji dokumentu, co utrudnia zmianÍ wyglπdu pod danπ firmÍ. W ostatnim przetestowanym programie czyli Gestor GT nie ma øadnej moøliwoúci edycji szablonÛw dokumentÛw.
...
Niniejszy rozdzia≥ zawiera opis technologii wykorzystanych do implementacji aplikacji. Zakres opisu obejmuje nastÍpujπce komponenty:
...
\subsection{Programy i wtyczki uøyte w Jenkins}
...
\begin{center}
$\displaystyle\frac{\mbox{Liczba dni potrzebnych do naprawienia b≥ÍdÛw}}{\mbox{Liczba dni potrzebnych do naprawy b≥Ídu z jednej linii kodu * Liczba linii kodu ürÛd≥owego}}$
\end{center}
...
Potencjalne b≥Ídy zapisywane sπ na liúcie zadaÒ, pokazanej na rysunku \ref{rys:SonarIssues}.

\begin{figure}[ht]
    \centering
    \includegraphics[width=1\textwidth]{SonarIssues.jpg}
    \caption{Lista zadaÒ w SonarQube, èrÛd≥o: Opracowanie w≥asne.}
...
Aby zapisaÊ propozycjÍ cenowπ do pliku PDF, naleøy wybraÊ z menu rozwijanego \textit{Menu} opcjÍ \textit{Lista propozycji}. 
...
Rysunek  Po klikniÍciu przycisku \textit{Zapisz do PDF}, pojawia siÍ dialog wyboru plikÛw. Uøytkownik wpisuje nazwÍ pliku oraz lokalizacjÍ zapisu. 
...
Jeøeli operacja siÍ powiod≥a, uøytkownik otrzyma komunikat.
...
Aby utworzyÊ nowe konto uøytkownika, w oknie g≥Ûwnym administrator wybiera z menu rozwijanego \textit{Uøytkownicy} opcjÍ \textit{Dodaj}.

%\begin{figure}[ht]
%    \centering
%    \includegraphics[width=0.35\textwidth]{dodaj.jpg}
%    \caption{Dodawanie uøytkownika z poziomu menu rozwijanego, èrÛd≥o: Opracowanie w≥asne.}
%	\label{rys:DodajUzytkownika}
%\end{figure}

NastÍpnie pojawia siÍ okno do ktÛrego wpisywane sπ dane uøytkownika. Aby dodaÊ uøytkownika naleøy kliknπÊ przycisk \textit{Dodaj}.

%\begin{figure}[ht]
%    \centering
%    \includegraphics[width=0.35\textwidth]{dodaj2.jpg}
%    \caption{Dodawanie uøytkownika, èrÛd≥o: Opracowanie w≥asne.}
%	\label{rys:DodajUøytkownika2}
%\end{figure}

Jeøeli dodawanie zakoÒczono sukcesem, uøytkownik otrzyma komunikat.

%\begin{figure}[ht]
%    \centering
%    \includegraphics[width=0.35\textwidth]{dodaj3.jpg}
%    \caption{Komunikat o poprawnym utworzeniu konta, èrÛd≥o: Opracowanie w≥asne.}
%	\label{rys:DodajUzytkownika3}
%\end{figure}

W przeciwnym wypadku, uøytkownik otrzyma komunikat o b≥Ídzie.

%\begin{figure}[ht]
%    \centering
%    \includegraphics[width=0.35\textwidth]{dodaj4.jpg}
%    \caption{Komunikat o b≥Ídach podczas prÛby utworzenia konta, èrÛd≥o: Opracowanie w≥asne.}
%	\label{rys:DodajUzytkownika4}
%\end{figure}

\subsubsection{Edycja konta}

Aby edytowaÊ dane uøytkownikÛw, w oknie g≥Ûwnym administrator wybiera z menu rozwijanego \textit{Uøytkownicy} opcjÍ \textit{Edytuj}.

%\begin{figure}[ht]
%    \centering
%    \includegraphics[width=0.35\textwidth]{edytujuz.jpg}
%    \caption{Edyja danych uøytkownikÛw z poziomu menu rozwijanego, èrÛd≥o: Opracowanie w≥asne.}
%	\label{rys:EdytujUzytkownika}
%\end{figure}

NastÍpnie zostanie otwarte nowe okno, ktÛre wyúwietla dane uøytkownikÛw w tabeli. Aby edytowaÊ dane naleøy zaznaczyÊ wybranπ komÛrkÍ, wpisaÊ tekst.

%\begin{figure}[ht]
%    \centering
%    \includegraphics[width=0.75\textwidth]{edytujuz2.jpg}
%    \caption{Okno edycji danych uøytkownikÛw, èrÛd≥o: Opracowanie w≥asne.}
%	\label{rys:EdytujUzytkownika2}
%\end{figure}

\subsubsection{Usuwanie konta}

Aby usunπÊ konto uøytkownika, w oknie g≥Ûwnym administrator wybiera z menu rozwijanego \textit{Uøytkownicy} opcjÍ \textit{UsuÒ}.

%\begin{figure}[ht]
%    \centering
%    \includegraphics[width=0.35\textwidth]{rm.jpg}
%    \caption{Usuwanie uøytkownikÛw z poziomu menu rozwijanego, èrÛd≥o: Opracowanie w≥asne.}
%	\label{rys:UsunUzytkownika}
%\end{figure}

NastÍpnie pojawia siÍ okno, w ktÛrym z listy rozwijanej administrator wybiera konto. Aby usunπÊ konto naleøy kliknπÊ przycisk \textit{UsuÒ}.

%\begin{figure}[ht]
%    \centering
%    \includegraphics[width=0.35\textwidth]{rm2.jpg}
%    \caption{Okno usuwanie uøytkownikÛw, èrÛd≥o: Opracowanie w≥asne.}
%	\label{rys:UsunUzytkownika2}
%\end{figure}

Jeøeli usuwanie powiod≥o siÍ, zostaje wyúwietlony komunikat.

%\begin{figure}[ht]
%    \centering
%    \includegraphics[width=0.35\textwidth]{rm3.jpg}
%    \caption{Komunikat o poprawnym usuniÍciu konta uøytkownika, èrÛd≥o: Opracowanie w≥asne.}
...
Aby zresetowaÊ has≥o uøytkownika, w oknie g≥Ûwnym administrator wybiera z menu rozwijanego \textit{Uøytkownicy} opcjÍ \textit{Resetuj has≥o}.

%\begin{figure}[ht]
%    \centering
%    \includegraphics[width=0.35\textwidth]{resetuj.jpg}
%    \caption{Resetowanie hase≥ uøytkownikÛw z poziomu menu rozwijanego, èrÛd≥o: Opracowanie w≥asne.}
%	\label{rys:ResetujHaslo}
%\end{figure}

NastÍpnie pojawia siÍ okno, w ktÛrym z listy rozwijanej administrator wybiera konto. Aby zresetowaÊ konto naleøy kliknπÊ przycisk \textit{Resetuj}.

%\begin{figure}[ht]
%    \centering
%    \includegraphics[width=0.35\textwidth]{reset2.jpg}
%    \caption{Okno resetowania hase≥, èrÛd≥o: Opracowanie w≥asne.}
%	\label{rys:ResetujHaslo2}
%\end{figure}

Jeøeli operacjπ powiod≥a siÍ, uøytkownik otrzyma komunikat.

%\begin{figure}[ht]
%    \centering
%    \includegraphics[width=0.35\textwidth]{reset3.jpg}
%    \caption{Komunikat o poprawnym usuniecia konta, èrÛd≥o: Opracowanie w≥asne.}
...
Aby umoøliwiúc edycjÍ danych z poziomu DataGridView, zaimplementowano funckjÍ obs≥ugujπcπ zdarzenie \textit{DataGridRowEditEndingEventArgs}. Kiedy edycja danej komÛrki zostaje zakoÒczona, wywo≥ywana jest funkcja ktÛrej zadaniem jest dynamiczne przechwytywanie nowych wartoúci oraz aktualizacja bazy danych. Uøycie zmiennej dynamic, podyktowane jest faktem, iø jest ona sprawdzana podczas wywo≥ania, a nie kompilacji \cite{dynamic}. Umoøliwia to odwo≥anie do nowych wartoúci zapisanych w komÛrkach. Funkcja jest wykorzystywana w module s≥uøπcym do edycji danych pracownikÛw. Poniøej znajduje siÍ kod ürÛd≥owy funkcji:

\begin{lstlisting}[caption= {Implementacja i opis funkcji aktualizujπcej bazÍ danych z poziomu DataGridView}, label={listing:DynamicGridView}]
...
Za pomocπ mechanizmÛw biblioteki MigraDoc, zaimplementowano funckje tworzπce tabele propozycji cenowej. Poniøej, znajduje siÍ przyk≥adowy kod ürÛd≥owy ktÛry tworzy nowπ kolumnÍ oraz w tabeli:
...
Poniøszy kod zosta≥ uøyty w implementacji funkcji zapisujπcej propozycjÍ cenowπ do pliku PDF:
...
\section{Podsumowanie oraz perspektywy rozwoju oprogramowania}
...
\bibitem{MsScaner}
http://docs.sonarqube.org/display/SONARNEXT/Installing+and+Configuring+SonarQube+Scanner+for+Jenkins
