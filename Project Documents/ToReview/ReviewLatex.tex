...
Stosowanie wzorca MVVM doprowadzi³o w prezentowanym projekcie do powstania rozbudowanego schematu solucji, w której sk³ad wchodzi ponad szeœædziesi¹t plików. Dziêki uporz¹dkowanej strukturze podzia³u na katalogi, uda³o siê jednak zachowaæ porz¹dek umo¿liwiaj¹cy p³ynne oraz intuicyjne odnalezienie szukanych elementów. Wszystkie pliki podzielone zosta³y pomiêdzy szeœæ folderów, których nazwy jednoznacznie determinuj¹ ich zastosowanie. Sama zawartoœæ przedstawionych katalogów zbudowana jest równie¿ w sposób umo¿liwiaj¹cy szybkie odnalezienie pliku, który zawiera szukane elementy. 

\begin{itemize}
\item \textsl{DataGridFillingObjects}

Folder \textsl{DataGridFillingObjects} zawiera, jak sama nazwa wskazuje, pliki obiektów, które u¿ywane s¹ do wype³niania tabel u¿ytkownika w prezentowanej aplikacji. 
