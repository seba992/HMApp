...
\subsection{Modyfikacja s³owników cenowych}
 ...
 \begin{itemize}
	...
	\tab 
	Ceny poszczególnych sal s¹ zale¿ne on miesiêcy, w których dane wydarzenie ma siê odbyæ. Nie ma mo¿liwoœci dodawania nowych sal. Przedstawia to rysunku \ref{rys:Sale}
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\textwidth]{Sale.jpg}
