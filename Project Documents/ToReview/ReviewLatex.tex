...
\begin{itemize}
	...
	\tab
	Jest to edytor wspomagaj¹c jêzyki Transact-SQL, MDX, DMX, lub XML/A. dziêki kolorowaniu s³ów kluczowych w trakcie pisania skryptów zwiêksza to czytelnoœæ kodu. Wykorzystuje siê tez jako interfejs do zapytañ Transact-SQL. Równie¿ jak opisany wczeœniej Visual Studio wykorzystuje mechanizm IntelliSense odpowiedzialny za podpowiadanie kolumn tabel.  Ma mo¿liwoœæ wykrywania b³êdów nieprawid³owej sk³adni.Wyœwietla b³êdy, ostrze¿enia i komunikaty informacyjne, które s¹ zwracane przez serwer.
