...
W przypadku zmian kadrowych, administrator posiada mo¿liwoœæ usuwania kont u¿ytkowników. Rysunek \ref{rys:UsunKonto} przedstawia okno obs³uguj¹ce funkcjonalnoœæ usuwania, które posiada listê rozwijan¹ zawieraj¹ca loginy u¿ytkowników. Po wybraniu loginu u¿ytkownika, którego konto ma zostaæ usuniête nale¿y klikn¹æ przycisk \textsl{Usuñ}. Pomyœlne usuniêcia konta z bazy danych jest potwierdzane komunikatem wyœwietlanym na rysunku \ref{rys:UsunKonto2}.
