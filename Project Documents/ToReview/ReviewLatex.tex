...
Do sprawdzenia dostêpnych rozwi¹zañ zosta³y wytypowane trzy programy, które spe³niaj¹ wymagania sieci hotelowej s¹ to: ProfitCRM\cite{ProfitCRM} i Asystent CRM\cite{AsystentCRM} Gestor GT \cite{Gestor}.
...
Podsumowuj¹c powy¿sze programy mo¿na zauwa¿yæ, ¿e proces dodawania produktów jest bardzo zbli¿ony. Podobnie sprawa wygl¹da z procesem wystawiania ofert, faktur. Najwiêksz¹ mo¿liwoœci¹ personalizacji wystawianych dokumentów ma program ProfitCRM. Poniewa¿ ¿aden z tych programów nie oferowa³ mo¿liwoœci wystawianie propozycji cenowej, a tak ¿¹danie mia³a sieæ hotelowa dlatego wynik³a koniecznoœæ stworzenia dedykowanej aplikacji. 
...
Bazy danych porównaæ mo¿na do archiwum firmy w którym przechowywane s¹ wszelkie projekty i dane osobowe. Tabel¹ w kontekœcie tego przyk³adu jest pojedynczy segregator zawieraj¹cy dane o identycznej tematyce. Tabela sk³ada siê z wierszy dalej zwanych rekordami i kolumn. Rekord tworzy spójn¹ ca³oœæ taki jak dla przyk³adu dane jednej osoby. Kolumny natomiast s¹ to poszczególne dane typu imiê, nazwisko oraz pesel. Tak jak pesel jest unikatowy dla osoby tak klucz g³ówny w tabeli te¿ musi byæ unikatowy. Po³¹czenie dwóch segregatorów poprzez dla przyk³adu numer pesel danej osoby to tak zwana relacja, w której w drugim segregatorze pesel stanowi klucz obcy.
W terminologii bazodanowej rozró¿niæ mo¿na kilka relacji, które przekszta³cone zosta³y z \cite{RelacjeBazDanych} na potrzeby przedstawianego przyk³adu:
