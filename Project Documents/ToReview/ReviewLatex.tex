...
Za pomoc¹ mechanizmów biblioteki MigraDoc, zaimplementowano funckje tworz¹ce tabele propozycji cenowej. Poni¿ej, znajduje siê przyk³adowy kod Ÿród³owy który tworzy now¹ kolumnê oraz w tabeli:
...
Poni¿szy kod zosta³ u¿yty w implementacji funkcji zapisuj¹cej propozycjê cenow¹ do pliku PDF:
