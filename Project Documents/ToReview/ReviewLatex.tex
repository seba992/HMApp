...
\newpage
Po klikniêciu w opcjê \textsl{Lista propozycji} zostaje wyœwietlona lista istniej¹cych propozycji cenowych. Oprócz podstawowych parametrów propozycji cenowych, w ostatniej kolumnie listy pojawia siê przycisk \textsl{Zapisz do PDF} którego klikniêcie otwiera dialog wyboru pliku. U¿ytkownik wpisuje dowoln¹ nazwê pliku, oraz wybiera lokalizacjê zapisu pliku co zosta³o pokazane na rysunku \ref{rys:ZapisDoPdf}. Je¿eli proces generowania pliku PDF przebiegnie pomyœlnie, zostaje wyœwietlony komunikat z informacj¹ o sukcesie, przedstawiony na rysunku \ref{rys:ZapisDoPdf2}. (dodaæ odnoœnik do za³¹cznika - wygenerowanego przez program PDF).
...
\begin{figure}[ht]
    ...
    \caption{Tabela zawieraj¹ca dane u¿ytkowników, ród³o: Opracowanie w³asne.}
